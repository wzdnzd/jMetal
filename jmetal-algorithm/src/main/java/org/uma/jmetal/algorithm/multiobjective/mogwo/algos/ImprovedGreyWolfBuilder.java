...
public class ImprovedGreyWolfBuilder<S extends Solution<?>> implements AlgorithmBuilder<Algorithm<List<DoubleSolution>>> {
    // 最大迭代次数
    ...
    public ImprovedGreyWolfBuilder(int maxEvaluations, int wolvesNum, Problem<DoubleSolution> problem, String name) {
    ...
    public ImprovedGreyWolfBuilder<S> setPositionInitializer(PositionInitializer positionInitializer) {
    ...
    public ImprovedGreyWolfBuilder<S> setVelocityInitializer(VelocityInitializer velocityInitializer) {
    ...
    public ImprovedGreyWolfBuilder<S> setLeaderSelector(LeaderSelector leaderSelector) {
    ...
    public ImprovedGreyWolfBuilder<S> setArchiveSize(int archiveSize) {
        if (archiveSize <= 0) {
    ...
    public ImprovedGreyWolfBuilder<S> setGridNum(int gridNum) {
        if (gridNum <= 0) {
    ...
    public ImprovedGreyWolfBuilder<S> setAlpha(double alpha) {
        if (alpha < 0) {
    ...
    public ImprovedGreyWolfBuilder<S> setDeleteStrategy(DeleteStrategy deleteStrategy) {
    ...
    public ImprovedGreyWolfBuilder<S> setDescription(String description) {
    ...
    public Algorithm<List<DoubleSolution>> build() {
        ...
        return new ImprovedGreyWolfAlgorithm(maxEvaluations, wolvesNum, positionInitializer, velocityInitializer,
